...
class SoundsofGame {
public:
    SoundBuffer soundOne, soundTwo, soundThree;
    Sound eggCatch, eggFallMusic, backMusic;
    
    SoundsofGame() {
        soundOne.loadFromFile("C:/Users/user/source/repos/ConsoleApplication2/backgroundMusic.mp3");
        soundTwo.loadFromFile("C:/Users/user/source/repos/ConsoleApplication2/eggcatchMusic.mp3");
        soundThree.loadFromFile("C:/Users/user/source/repos/ConsoleApplication2/eggfallMusic.mp3");

        eggCatch.setBuffer(soundTwo);
        backMusic.setBuffer(soundOne);
        eggFallMusic.setBuffer(soundThree);
    }
};
